...
def get_parser():
    ...
    parser.add_argument("-c", "--convnet", default="resnet34", type=str,
    ...
    parser.add_argument("-memory", "--memory-size", default=1000, type=int,
    ...
    parser.add_argument("--lembda","--lembda", default=[1], type=float, help="weight of regularization term")
    return parser
