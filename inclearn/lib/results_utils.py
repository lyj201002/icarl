...
def save_results(results, label):
    ...
    file_path = "original_Euclidean_1000_{}.json".format(results["config"]["lembda"])
    #file_path = "resnet34_{}.json".format(results["config"]["seed"])
    #file_path = "original_Euclidean_1000_1_15.json"
